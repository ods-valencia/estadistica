...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, decimalSeparator) {
    ...
    $('#map').sdgMap({
      ...
      mapOptions: {"minZoom":5,"maxZoom":10,"tileURL":"https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png","tileOptions":{"attribution":"<a href=\"https://www.openstreetmap.org/copyright\">OpenStreetMap</a>"},"colorRange":"chroma.brewer.BuGn","noValueColor":"#f0f0f0","styleNormal":{"weight":1,"opacity":1,"fillOpacity":0.7,"color":"#888888","dashArray":""},"styleHighlighted":{"weight":1,"opacity":1,"fillOpacity":0.7,"color":"#111111","dashArray":""},"styleStatic":{"weight":2,"opacity":1,"fillOpacity":0,"color":"#172d44","dashArray":"5,5"}},
      mapLayers: [{"subfolder":"regions","label":"Distritos","min_zoom":5,"max_zoom":10,"staticBorders":true}],
      precision: precision,
